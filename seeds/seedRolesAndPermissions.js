...
const rolesPermissions = {
  ...
  Admin: ["manage_users", "edit_settings", "generate_reports", "manage_properties", "oversee_operations"],
  "Front Desk Manager": [
    "manage_front_desk",
    "checkin_checkout",
    "manage_room_assignments",
    "handle_guest_inquiries",
    "generate_fd_reports",
  ],
  "Housekeeping Manager": [
    ...
    "assign_cleaning",
    "update_room_status",
    "manage_cleaning_inventory",
    "generate_hk_reports",
  ],
  "Reservations Manager": [
    "manage_bookings",
    "modify_reservations",
    "handle_group_bookings",
    "monitor_occupancy",
    "generate_reservation_reports",
  ],
  "Sales and Marketing Manager": [
    ...
    "manage_online_presence",
  ],
  "Food and Beverage Manager": [
    "manage_restaurant",
    "menu_planning",
    "manage_food_inventory",
    "handle_catering",
    "generate_fb_reports",
  ],
  "Maintenance Manager": [
  ...
  "Accounting/Finance Manager": [
    ...
    "handle_payroll",
    "manage_budgets",
    "compliance_financials",
  ],
  "IT Support": ["manage_security", "technical_support", "software_updates", "data_backups", "compliance_data"],
  "Guest Services Agent": ["assist_guests", "handle_checkin_checkout", "manage_feedback", "access_guest_profiles"],
  "Event Coordinator": [
    "manage_events",
    "coordinate_vendors",
    "oversee_event_execution",
    "event_reports",
    "manage_event_contracts",
  ],
  "Security Personnel": ["monitor_premises", "access_surveillance", "handle_emergencies", "incident_reporting"],
