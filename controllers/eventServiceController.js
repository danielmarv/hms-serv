 ...
 * @access  Private
 */
export const getAllEventServices = asyncHandler(async (req, res) => {
 ...
 * @access  Private
 */
export const getEventServiceById = asyncHandler(async (req, res) => {
 ...
 * @access  Private
 */
export const deleteEventService = asyncHandler(async (req, res) => {
 ...
 * @access  Private
 */
export const removeServiceFromBooking = asyncHandler(async (req, res) => {
